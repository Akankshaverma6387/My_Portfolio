        ...
        <div className="row g-4 mt-4">
          ...
          <div className="col-md-4">
            <a href="https://github.com/Akankshaverma6387" className="contact-box">
              <i className="fa-brands fa-github contact-icon github-icon"></i>
              <b><h4 >GitHub</h4></b>
              <p className="text-muted">Explore my projects and coding journey.</p>
            </a>
          </div>
          ...
          <div className="col-md-4">
            <a href="akankshaverma919827@gmail.com" className="contact-box">
              ...
              <b><h4 >Email</h4></b>
              <p className="text-muted">Feel free to reach out for opportunities.</p>
            </a>
          </div>

          <div className="col-md-4">
            <a href="https://www.linkedin.com/in/akanksha-verma-7a8723321" className="contact-box">
              <i className="fa-brands fa-linkedin contact-icon linkedin-icon"></i>
              <b><h4 >LinkedIn</h4></b>
              <p className="text-muted">Connect with me and let's grow together.</p>
            </a>
          </div>
